...
;($window => {
  ...
  // menu items
  const MENU_ITEMS_URL = 'https://davids-restaurant.herokuapp.com/menu_items.json?category='
  ...
  DC.loadMenuItems = categoryShortName => {
    showLoading('#main-content')
    $ajaxUtils.sendGetRequest(MENU_ITEMS_URL + categoryShortName, buildAndShowMenuItemsHTML)
  }
